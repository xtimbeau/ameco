...
url_ameco <- function(version = "11025") {
  ameco_url <- c(
    ...
    "52025" = "https://economy-finance.ec.europa.eu/document/download/b4b375e7-80a6-4581-b8fd-9c207790cd01_en?filename=ameco0.zip",
    "112025" = "https://ec.europa.eu/economy_finance/db_indicators/ameco/documents/ameco0.zip"
  )
